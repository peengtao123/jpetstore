...
public class AccountController {
    ...
    public String newAccount(@Validated({NewAccount.class, Default.class}) AccountForm form, BindingResult result) {
        if (result.hasErrors()) {
            return "account/NewAccountForm";
        }
    ...
    public String editAccount(@Validated({EditAccount.class, Default.class}) AccountForm form, BindingResult result) {
        if (result.hasErrors()) {
            UserDetails userDetails = (UserDetails) SecurityContextHolder
                    .getContext().getAuthentication().getPrincipal();
